...
<br><br>Do not forget to add the shell file to the directory in WP-XPL0IT root (``ak.png picture defines the bot on what file it needs to click,it will automaticly detect it screen x,y location and will be uploading it on the wordpress website``)<br>
